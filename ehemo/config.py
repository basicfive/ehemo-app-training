...
class TrainingConfig(BaseModel):
    ...
    # model
    base_model_path: str = os.path.join(ROOT_DIR, "ehemo", "models", "checkpoints", "flux1-dev.safetensors")
    t5xxl_path: str = os.path.join(ROOT_DIR, "ehemo", "models", "vae", "t5xxl_fp16.safetensors")
